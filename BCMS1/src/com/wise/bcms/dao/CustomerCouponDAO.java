...
import com.wise.bcms.dto.CustomerCoupon;
...
public class CustomerCouponDAO {
	public int add(CustomerCoupon customerCoupon) {
			...
			try(Connection connection = DBUtility.getConnection()){
				...
				preparedStatement.setDate(3, DBUtility.convertFromUTILDateToSQLDate(customerCoupon.getValidDate()));
	...
	public List<CustomerCoupon> get(int customerId) {
		...
		final String QUERY = "select cc.coupon_id, cc.valid_date, cc.month, cc.year, d.amount from customer_coupons cc, coupons c, denomination d where cc.customer_id = ? and c.coupon_id = cc.coupon_id and d.denominationid = c.denomination_id";
		try (Connection connection = DBUtility.getConnection()) {
			...
			while(resultSet.next()) {
				...
				customerCoupon.setValidDate(DBUtility.convertFromSQLDateToUTILDate(resultSet.getDate(2)));
	...
	public List<CustomerCoupon> get() {	
		...
		ResultSet resultSet = null;
		PreparedStatement preparedStatement = null;
		final String QUERY = "select cc.coupon_id, cc.valid_date, cc.month, cc.year, d.amount, cc.customer_id from customer_coupons cc, coupons c, denomination d where c.coupon_id = cc.coupon_id and d.denomination_id = c.denomination_id";
		try (Connection connection = DBUtility.getConnection()) {
			preparedStatement = connection.prepareStatement(QUERY);
			resultSet = preparedStatement.executeQuery();
			while(resultSet.next()) {
				...
				customerCoupon.setCustomer(customer);
				customerCoupon.setValidDate(DBUtility.convertFromUTILDateToSQLDate(resultSet.getDate(2)));
				customerCoupon.setMonth(resultSet.getString(3));
				customerCoupon.setYear(resultSet.getInt(4));
				Denomination denomination = new Denomination();
				denomination.setAmount(resultSet.getDouble(5));
	...
	public List<CustomerCoupon> validCoupons(int customerId) {
		...
		ResultSet resultSet = null;
		PreparedStatement preparedStatement = null;
		final String QUERY = "select cc.coupon_id, cc.valid_date, cc.month, cc.year, d.amount from customer_coupons cc, coupons c, denomination d where cc.customer_id = ? and c.coupon_id = cc.coupon_id and d.denomination_id = c.denomination_id and valid_date >= curdate()";
		try (Connection connection = DBUtility.getConnection()) {
			preparedStatement = connection.prepareStatement(QUERY);
			preparedStatement.setInt(1, customerId);
			resultSet = preparedStatement.executeQuery();
	...
	public List<CustomerCoupon> getUsedCoupons(int customerId) {
		...
		ResultSet resultSet = null;
		PreparedStatement preparedStatement = null;
		final String QUERY = "select cc.coupon_id, cc.valid_date, cc.month, cc.year, d.amount from customer_coupons cc, coupons c, denomination d, used_coupon uc where cc.coupon_id=? and c.coupon_id = cc.coupon_id and d.denomination_id = c.denomination_id and uc.coupon_id = cc.coupon_id";
		try (Connection connection = DBUtility.getConnection()) {
			preparedStatement = connection.prepareStatement(QUERY);
			preparedStatement.setInt(1, customerId);
			resultSet = preparedStatement.executeQuery();
